    ...
    <div class="top-header">
        <div class="container">
            <div class="nav-top-links">
                ...
                <a href="#"><img alt="email" src="{{asset('frontend')}}/assets/images/email.png" />Contact us today!</a>
            </div>
            <div class="currency ">
                <div class="dropdown">
    ...
    <div class="container main-header">
        <div class="row">
            <div class="col-xs-12 col-sm-3 logo">
                <a href="index.html"><img alt="Kute Shop" src="{{asset('frontend')}}/assets/images/logo.png" /></a>
            </div>
                            ...
                            <ul>
                                <li class="product-info">
                                    <div class="p-left">
                                        ...
                                        <a href="#">
                                        <img class="img-responsive" src="{{asset('frontend')}}/assets/data/product-100x122.jpg" alt="p10">
                                        </a>
                                    </div>
                                    <div class="p-right">
                                ...
                                <li class="product-info">
                                    <div class="p-left">
                                        <a href="#" class="remove_link"></a>
                                        <a href="#">
                                        <img class="img-responsive" src="{{asset('frontend')}}/assets/data/product-s5-100x122.jpg" alt="p10">
                                        </a>
                                    </div>
                                    <div class="p-right">
                                        <p class="p-name">Donec Ac Tempus</p>
                ...
                <div class="col-sm-3" id="box-vertical-megamenus">
                    ...
                    <div class="vertical-menu-content is-home">
                        <ul class="vertical-menu-list">
                            <li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="{{asset('frontend')}}/assets/data/1.png">Electronics</a></li>
                            <li>
                                <a class="parent" href="category2.html"><img class="icon-menu" alt="Funky roots" src="{{asset('frontend')}}/assets/data/2.png">Sports &amp; Outdoors</a>
                            ...
                            <li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="{{asset('frontend')}}/assets/data/3.png">Smartphone &amp; Tablets</a></li>
                            <li><a href="category2.html"><img class="icon-menu" alt="Funky roots" src="{{asset('frontend')}}/assets/data/4.png">Health &amp; Beauty Bags</a></li>
                            <li>
                                <a class="parent" href="category.html">
                                <img class="icon-menu" alt="Funky roots" src="{{asset('frontend')}}/assets/data/5.png">Shoes &amp; Accessories</a>
                                <div class="vertical-dropdown-menu">
                                        <div class="vertical-groups col-sm-12">
                                                ...
                                                <div class="row mega-products">
                                                    <div class="col-sm-3 mega-product">
                                                        <div class="product-avatar">
                                                            <a href="#"><img src="{{asset('frontend')}}/assets/data/p10.jpg" alt="product1"></a>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-3 mega-product">
                                                        <div class="product-avatar">
                                                            <a href="#"><img src="{{asset('frontend')}}/assets/data/p11.jpg" alt="product1"></a>
                                                        </div>
                                                        <div class="product-name">
                                                            <a href="#">Fashion hand bag</a>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-3 mega-product">
                                                        <div class="product-avatar">
                                                            <a href="#"><img src="{{asset('frontend')}}/assets/data/p12.jpg" alt="product1"></a>
                                                        </div>
                                                        <div class="product-name">
                                                            <a href="#">Fashion hand bag</a>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-3 mega-product">
                                                        <div class="product-avatar">
                                                            <a href="#"><img src="{{asset('frontend')}}/assets/data/p13.jpg" alt="product1"></a>
                                                        </div>
                                                        <div class="product-name">
                                                            <a href="#">Fashion hand bag</a>
                                                        </div>
                            ...
                            <li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="{{asset('frontend')}}/assets/data/6.png">Toys &amp; Hobbies</a></li>
                            <li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="{{asset('frontend')}}/assets/data/7.png">Computers &amp; Networking</a></li>
                            <li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="{{asset('frontend')}}/assets/data/8.png">Laptops &amp; Accessories</a></li>
                            <li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="{{asset('frontend')}}/assets/data/9.png">Jewelry &amp; Watches</a></li>
                            <li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="{{asset('frontend')}}/assets/data/10.png">Flashlights &amp; Lamps</a></li>
                            <li>
                                <a href="category.html">
                                    <img class="icon-menu" alt="Funky roots" src="{{asset('frontend')}}/assets/data/11.png">
                                    Cameras &amp; Photo
                                </a>
                            </li>
                                            ...
                                            <li class="block-container col-sm-3">
                                                <ul class="block">
                                                    <li class="img_container">
                                                        <a href="#">
                                                            <img class="img-responsive" src="{{asset('frontend')}}/assets/data/men.png" alt="sport">
                                                        </a>
                                                    </li>
                                             ...
                                             <li class="block-container col-sm-3">
                                                <ul class="block">
                                                    <li class="img_container">
                                                        <a href="#">
                                                            <img class="img-responsive" src="{{asset('frontend')}}/assets/data/women.png" alt="sport">
                                                        </a>
                                                    </li>
                                                    <li class="link_container group_header">
                                                        <a href="#">WOMEN'S</a>
                                             ...
                                             <li class="block-container col-sm-3">
                                                <ul class="block">
                                                    <li class="img_container">
                                                        <a href="#">
                                                            <img class="img-responsive" src="{{asset('frontend')}}/assets/data/kid.png" alt="sport">
                                                        </a>
                                                    </li>
                                                    <li class="link_container group_header">
                                                        <a href="#">Kids</a>
                                             ...
                                             <li class="block-container col-sm-3">
                                                <ul class="block">
                                                    <li class="img_container">
                                                        <a href="#">
                                                            <img class="img-responsive" src="{{asset('frontend')}}/assets/data/trending.png" alt="sport">
                                                        </a>
                                                    </li>
                                                    <li class="link_container group_header">
                                                        <a href="#">TRENDING</a>
                                    ...
                                    <li class="dropdown">
                                        <a href="category.html" class="dropdown-toggle" data-toggle="dropdown">Foods</a>
                                            ...
                                            <li class="block-container col-sm-3">
                                                <ul class="block">
                                                    <li class="img_container">
                                                        <img src="{{asset('frontend')}}/assets/data/banner-topmenu.jpg" alt="Banner">
                                                    </li>
                                                </ul>
                                            </li>
            ...
            <div class="column col-xs-12 col-sm-3" id="left_column">
                ...
                <div class="col-left-slide left-module">
                    <ul class="owl-carousel owl-style2" data-loop="true" data-nav = "false" data-margin = "30" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-items="1" data-autoplay="true">
                        <li><a href="#"><img src="{{asset('frontend')}}/assets/data/slide-left.jpg" alt="slide-left"></a></li>
                        <li><a href="#"><img src="{{asset('frontend')}}/assets/data/slide-left2.jpg" alt="slide-left"></a></li>
                        <li><a href="#"><img src="{{asset('frontend')}}/assets/data/slide-left3.png" alt="slide-left"></a></li>
                    </ul>
                        ...
                        <ul class="products-block">
                            <li>
                                <div class="products-block-left">
                                    <a href="#">
                                        <img src="{{asset('frontend')}}/assets/data/product-100x122.jpg" alt="SPECIAL PRODUCTS">
                                    </a>
                                </div>
                        ...
                        <ul class="testimonials owl-carousel" data-loop="true" data-nav = "false" data-margin = "30" data-autoplayTimeout="1000" data-autoplay="true" data-autoplayHoverPause = "true" data-items="1">
                            <li>
                                ...
                                <div class="client-avarta">
                                    <img src="{{asset('frontend')}}/assets/data/testimonial.jpg" alt="client-avarta">
                                </div>
            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                <div class="category-slider">
                    <ul class="owl-carousel owl-style2" data-dots="false" data-loop="true" data-nav = "true" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-items="1">
                        <li>
                            <img src="{{asset('frontend')}}/assets/data/category-slide.jpg" alt="category-slider">
                        </li>
                        <li>
                            <img src="{{asset('frontend')}}/assets/data/slide-cart2.jpg" alt="category-slider">
                        </li>
                    </ul>
                </div>
                <!-- ./category-slider -->
                    ...
                    <ul class="row product-list grid">
                        ...
                        <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="detail.html">
                                        <img class="img-responsive" alt="product" src="{{asset('frontend')}}/assets/data/p41.jpg" />
                                    </a>
                                    <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
                        ...
                        <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="detail.html">
                                        <img class="img-responsive" alt="product" src="{{asset('frontend')}}/assets/data/p38.jpg" />
                                    </a>
                                    <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
                        ...
                        <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="detail.html">
                                        <img class="img-responsive" alt="product" src="{{asset('frontend')}}/assets/data/product-300x366.jpg" />
                                    </a>
                                    <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
                        ...
                        <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="detail.html">
                                        <img class="img-responsive" alt="product" src="{{asset('frontend')}}/assets/data/p42.jpg" />
                                    </a>
                                    <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
                        ...
                        <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="detail.html">
                                        <img class="img-responsive" alt="product" src="{{asset('frontend')}}/assets/data/p89.jpg" />
                                    </a>
                                    <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
                        ...
                        <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="detail.html">
                                        <img class="img-responsive" alt="product" src="{{asset('frontend')}}/assets/data/p90.jpg" />
                                    </a>
                                    <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
                        ...
                        <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="detail.html">
                                        <img class="img-responsive" alt="product" src="{{asset('frontend')}}/assets/data/p91.jpg" />
                                    </a>
                                    <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
                        ...
                        <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="detail.html">
                                        <img class="img-responsive" alt="product" src="{{asset('frontend')}}/assets/data/p92.jpg" />
                                    </a>
                                    <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
                        ...
                        <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="detail.html">
                                        <img class="img-responsive" alt="product" src="{{asset('frontend')}}/assets/data/p93.jpg" />
                                    </a>
                                    <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
                        ...
                        <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="detail.html">
                                        <img class="img-responsive" alt="product" src="{{asset('frontend')}}/assets/data/p94.jpg" />
                                    </a>
                                    <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
                        ...
                        <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="detail.html">
                                        <img class="img-responsive" alt="product" src="{{asset('frontend')}}/assets/data/p95.jpg" />
                                    </a>
                                    <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
                        ...
                        <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="detail.html">
                                        <img class="img-responsive" alt="product" src="{{asset('frontend')}}/assets/data/p96.jpg" />
                                    </a>
                                    <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
            ...
            <div id="trademark-box" class="row">
                <div class="col-sm-12">
                    <ul id="trademark-list">
                        ...
                        <li>
                            <a href="#"><img src="{{asset('frontend')}}/assets/data/trademark-ups.jpg"  alt="ups"/></a>
                        </li>
                        <li>
                            <a href="#"><img src="{{asset('frontend')}}/assets/data/trademark-qiwi.jpg"  alt="ups"/></a>
                        </li>
                        <li>
                            <a href="#"><img src="{{asset('frontend')}}/assets/data/trademark-wu.jpg"  alt="ups"/></a>
                        </li>
                        <li>
                            <a href="#"><img src="{{asset('frontend')}}/assets/data/trademark-cn.jpg"  alt="ups"/></a>
                        </li>
                        <li>
                            <a href="#"><img src="{{asset('frontend')}}/assets/data/trademark-visa.jpg"  alt="ups"/></a>
                        </li>
                        <li>
                            <a href="#"><img src="{{asset('frontend')}}/assets/data/trademark-mc.jpg"  alt="ups"/></a>
                        </li>
                        <li>
                            <a href="#"><img src="{{asset('frontend')}}/assets/data/trademark-ems.jpg"  alt="ups"/></a>
                        </li>
                        <li>
                            <a href="#"><img src="{{asset('frontend')}}/assets/data/trademark-dhl.jpg"  alt="ups"/></a>
                        </li>
                        <li>
                            <a href="#"><img src="{{asset('frontend')}}/assets/data/trademark-fe.jpg"  alt="ups"/></a>
                        </li>
                        <li>
                            <a href="#"><img src="{{asset('frontend')}}/assets/data/trademark-wm.jpg"  alt="ups"/></a>
                        </li>
                    </ul> 
                </div>
            </div> <!-- /#trademark-box -->
